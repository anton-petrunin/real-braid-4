...
If a point in $\CB^n$ has $k$ distinct punctures, then it admits a neighborhood of that is isometric to an open set in the product $\CB^{i_1}\times\ldots\times\CB^{i_k}$; here $i_1+\z\ldots+i_k=n$.
