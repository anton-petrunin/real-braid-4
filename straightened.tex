...
There is a universal bound on the number of collisions of geodesics in $\CB^n$.
\end{thm}
...
the cone over such a geodesic is a planar angle that is isometrically embedded into $\CB^n$.
...
This observation reduces the question to finding universal bound for the number of collisions of geodesic $\gamma$ that has length at most $\eps$ and such that $\bar\gamma$ lies at the distance at least $1$ from the diagonal line.

If a point in $\CB^n$ has $k$ distinct punctures, then it admits a neighborhood of that is isometric to an open set in the product $\CB^{i_1}\times\dots\times\CB^{i_k}$; here $i_1+\z\ldots+i_k=n$.
