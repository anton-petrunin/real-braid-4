...
Indeed, before and after $t_0$ the geodesic goes runs in a radial direction of the cone structure of $\CB^n$ with respect to $\gamma(t_0)$ and so can not branch off the radial direction.
