...
If $p_1(t)=\ldots=p_n(t)$ for some $t$, then $\gamma$ can have a collision only at time $t$.
Indeed, before and after $t$ the geodesic goes runs in a radial direction of a cone structure of $\CB^n$.
