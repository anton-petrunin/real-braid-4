...
The curve can be closed or open; in this case, we assume that $\lambda$ connects two fixed ideal points  of $\CC$.
...
In this case, $f(\bm{p})$ is defined as the excess of its length compared to the two-edge curve passing through the origin.
