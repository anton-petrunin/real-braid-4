...
Indeed, by the Kurosh subgroup theorem $H=\langle x \rangle*H'$ for some $H'<H$ and since $H$ is a free group with two generators, $H'$ is an infinite cyclic group.
(I do not understand this part, but let's believe it for a while.)

We can rewrite the equation as
\[p_1d^{n_1}p_2 = d^{-n_3}p_3^{-1}d^{-n_2}.\]
...
\[p_1\langle a\rangle= a^{-n_3}p_3^{-1}\langle a\rangle.\]
I hope it can help to prove the lemma.
