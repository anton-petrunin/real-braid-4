...
Therefore, the theorems gives a special case of the conjecture for $n=4$.


\section{Real braid space}

Given $K\subset \CC$, denote by $\KB^n$ of the inverse image $K^n\subset \CC^n$ under the natural projection $\CB^n\to \CC^n$.
...
in other words, one of two arcs connecting any two points on the currve is a minimizing geodesic.
