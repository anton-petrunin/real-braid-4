...
Suppose $\Sigma$ has a closed stable geodesic of length less than $2\cdot\pi$;
...
\]
The inequalities above leave only
\[
(k,q)=(1,0),(2,0),(1,1),(0,1),(0,2),(0,3),
\]
which give respectively
\[
AB,\quad ABAB,\quad ABAC,\quad AC,\quad ACAC,\quad ACACAC.
\]
...
Unfolding at $C$, the nearest distinct images of $C$ are at distance $\pi/2$, and, up to symmetry, the corresponding trajectory is $CM$.
\qeds
