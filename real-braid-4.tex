...
\section{Sphere in the real braid space}
...
In particular, $\Sigma$ has \emph{finitely many shapes}; that is, there are only finitely many isometry classes of simplices.
...
\begin{align*}
s'''&\in \langle c\rangle,
\\
s''&\in \langle b\rangle\cdot\langle c\rangle,
\\
s'&\in \langle a\rangle\cdot\langle b\rangle\cdot\langle c\rangle,
\\
s&\in \langle c\rangle\cdot\langle a\rangle\cdot\langle b\rangle\cdot\langle c\rangle=\langle c\rangle\cdot\langle a, b\rangle\cdot\langle c\rangle,
\end{align*}
\qeds
